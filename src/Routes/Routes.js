...
export const routes = createBrowserRouter([
    {
        ...
        children: [
            ...
            },
            {
                ...
                loader: ({ params }) => fetch(`https://project-ten-server.vercel.app/courses/${params.id}`)
            },
            {
                path: '/checkout/:id',
    ...
    },
    {
        path: '*', element: <div><body>
            ...
            <div class="text" className='d-flex flex-column justify-content-center align-items-center'>
                <h1>404 Error</h1>
                <h2>Couldn't launch :(</h2>
                <h3>Page Not Found - lets take you <a href="https://project-ten-client.web.app/">BACK</a></h3>
            </div>
        </body>
        </div>
    }
